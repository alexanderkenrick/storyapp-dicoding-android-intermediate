...
import com.alexander.storyapp.DataDummy
import com.alexander.storyapp.MainDispatcherRule
import com.alexander.storyapp.data.repository.AuthRepository
import com.alexander.storyapp.data.response.story.Story
import com.alexander.storyapp.getOrAwaitValue
...
class MainViewModelTest {
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        ...
        val actualStory: PagingData<Story> = homeViewModel.story.getOrAwaitValue()
